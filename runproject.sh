...
#打开bitmex合约工具
open -a Terminal.app market/bitmex/startDataServer.sh

sleep 1

open -a Terminal.app market/bitmex/startTradeServer.sh

sleep 1


# 打开okex季度合约工具
open -a Terminal.app market/okex/startDataServer.sh

sleep 1

open -a Terminal.app market/okex/startTradeServer.sh
