...
port = apikeytool.apikeydic['okexw1']['wsport']
host = apikeytool.apikeydic['okexw1']['wsaddr']
addr = (host,port)
...
def startDataServer():
    global tradetool
    apikey = apikeytool.apikeydic['okexw1']['apikey']
    secretkey = apikeytool.apikeydic['okexw1']['secretkey']
    tradetool = okWebSocket.okWSTool(apikey,secretkey)
    tradetool.setObjName('okexw1')
